...
export const ALLOWED_WORK_TYPES = ['사상작업', '검사작업']
...
export function createSampleWorkbook(): Blob {
  const rows = [
    ...
    {
      날짜: '2026-08-03', 작업구분: '사상작업', 검사원: '이준호', 소속: '본사',
    ...
    {
      날짜: '2026-08-06', 작업구분: '사상작업', 검사원: '한도윤', 소속: '본사',
    ...
    {
      날짜: '2026-08-09', 작업구분: '사상작업', 검사원: '이준호', 소속: '본사',
