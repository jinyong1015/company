...
- **설비 × 불량 유형 히트맵** (행·열 합계, 1공장/2공장 소계)
...
| --- | --- | --- | --- |
| 대시보드 | 전사 품질 현황 요약 | KPI, 그룹비교+추이, 설비×불량 히트맵, 품번 TOP | 품질·검사관리자 |
| 품질 분석 | 불량 주원인 파악 | 유형별 발생량·품번 매칭 · 선택상태 유지 | 품질관리자 |
| 검사자 분석 | 인력 효율·품질 평가 | 검수량 TOP · 소속별 검수량·UPH · 상세 복귀 시 페이지 유지 | 검사관리자 |
| 품번 분석 | 제품 단위 위험 관리 | 검수량 TOP · 검수량/폐기비용·ppm 추이 · 불량→설비·금형 · 목록 조건 유지 | 품질관리자 |
...
| 성형작업자 분석 | 성형 실적·부적합 | 부적합수량 TOP · 작업자 상세 | 생산·품질관리자 |
...
- [화면설계서](./화면설계서.md) — UI/UX·화면·지표·메뉴 명세 (최신 V29)
